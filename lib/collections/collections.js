 ...
 */
export const ViewHistory = new Mongo.Collection("ViewHistory");
ViewHistory.attachSchema(Schemas.ViewHistory);

/**
 * Purchase History Collection
 */
export const PurchaseHistory = new Mongo.Collection("PurchaseHistory");
PurchaseHistory.attachSchema(Schemas.PurchaseHistory);
